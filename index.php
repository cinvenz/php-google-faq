...
$arr_text = [
    [
        'domanda' => <<<STR
        <h2 class="SbNcad">Come state implementando la recente decisione della Corte di giustizia dell'Unione europea (CGUE) relativa al diritto all'oblio?</h2>
        STR,
        'risposta' => <<<STR
    ...
    [
        'domanda' => <<<STR
        <h2 class="SbNcad">Quando faccio clic sui risultati della Ricerca Google, le mie chiavi di ricerca vengono inviate ai siti web?</h2>
        STR,
        'risposta' => <<<STR
